...
class CWRU_OR_centred():
    def __init__(self):
        super(CWRU_OR_centred, self).__init__()
        self.train_params = {
            'num_epochs': 40,
            'batch_size': 32,
            'weight_decay': 1e-4,
...
class CWRU_OR_orthogonal():
    def __init__(self):
        super(CWRU_OR_orthogonal, self).__init__()
        self.train_params = {
            'num_epochs': 40,
            'batch_size': 32,
            'weight_decay': 1e-4,
...
class CWRU_OR_opposite():
    def __init__(self):
        super(CWRU_OR_opposite, self).__init__()
        self.train_params = {
            'num_epochs': 40,
            'batch_size': 32,
            'weight_decay': 1e-4,
